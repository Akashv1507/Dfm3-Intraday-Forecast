        ...
        try:
            ...
            try:
                ...
                try:
                    ...
                    del_sql = "DELETE FROM dfm3_dayahead_demand_forecast WHERE time_stamp = :1 and entity_tag=:2"
                    cur.executemany(del_sql, existingRows)
                    insert_sql = "INSERT INTO dfm3_dayahead_demand_forecast(time_stamp,ENTITY_TAG,forecasted_demand_value) VALUES(:1, :2, :3)"
